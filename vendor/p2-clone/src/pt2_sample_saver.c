...
bool saveSample(bool checkIfFileExist, bool giveNewFreeFilename)
{
	...
	switch (diskop.smpSaveType)
	{
		case DISKOP_SMP_WAV: pt2_web_export_file(fileName, "audio/wav"); break;
		case DISKOP_SMP_IFF: pt2_web_export_file(fileName, "audio/x-iff"); break;
		default:             pt2_web_export_file(fileName, "application/octet-stream"); break;
	}
