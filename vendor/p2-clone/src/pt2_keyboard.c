...
static bool injectedKeyModifiersActive = false;
static bool injectedCtrlPressed = false;
static bool injectedAltPressed = false;
static bool injectedShiftPressed = false;
static bool injectedAmigaPressed = false;
#endif
...
void setInjectedKeyModifiers(bool ctrlPressed, bool altPressed, bool shiftPressed, bool amigaPressed)
{
#ifdef __EMSCRIPTEN__
	injectedKeyModifiersActive = true;
	injectedCtrlPressed = ctrlPressed;
	injectedAltPressed = altPressed;
	injectedShiftPressed = shiftPressed;
	injectedAmigaPressed = amigaPressed;
#else
	(void)ctrlPressed;
	(void)altPressed;
	(void)shiftPressed;
...
{
#ifdef __EMSCRIPTEN__
	if (injectedKeyModifiersActive)
	{
		keyb.leftCtrlPressed = injectedCtrlPressed;
		keyb.leftAltPressed = injectedAltPressed;
		keyb.shiftPressed = injectedShiftPressed;
#ifdef __APPLE__
		keyb.leftCommandPressed = injectedAmigaPressed;
#endif
		keyb.leftAmigaPressed = injectedAmigaPressed;
		return;
	}
#endif
